...
<body>
    ...
    <div id='container'>
        <div id='content-edit'>
            <table cellspacing=5 id='table-edit'>
                <tr>
                    <td><label class='lbl'>Nama Siswa</label></td>
                    <td><label class='lbl'>Email</label></td>
                </tr>
                <tr>
                    <td><input type="text" value='<?php echo $nama ;?>' placeholder='Masukan Nama' name='txtNamaSiswa' id='txtnama' class='input'></td>
                    <td><input type="text" value=<?php echo $email ;?> class='input' placeholder='Masukan Email' id='txtemail'></td>
                </tr>
                <tr>
                    <td><label class='lbl'>Kelas Siswa</label></td>
                    <td><label class='lbl'>Username</label></td>
                </tr>
                <tr>
                    <td>
                        <select id='cbkelas-edit' class='input' id='cbkelas'>
                            <option value="<?php echo $kelasid ;?>" ><?php echo $kelas ;?></option>
                        </select>
                    </td>
                ...
                <tr>
                    <td><label class='lbl'>Nama Sekolah</label></td>
                </tr>
                <tr>
                    <td><input type="text" value='<?php echo $sekolah ;?>' class='input' placeholder='Nama Sekolah' id='txtnamasekolah'></td>
                    <td>
    ...
    <script>
        ...
        $("#btnSimpan").click(function(){
            ...
            var kelasid = $("#cbkelas-edit").val();
            var nama = $("#txtnama").val();
            var namasekolah = $("#txtnamasekolah").val();
            var email = $("#txtemail").val();
            var nohp = $("#txtnohp").val();
            var password = $("#txtpassword").val();
            var tanggal_lahir = $("#txttgl_lahir").val();
            $.post("update-siswa-ajax.php", {username:username,
            nama:nama, kelasid:kelasid,
