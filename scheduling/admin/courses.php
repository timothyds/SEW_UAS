	...
	<div class="col-lg-12">
		<div class="row">
			...
			<form action="" id="manage-course">
				<div class="card" style="background-color: #164863;">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label" style="color: white;">Course</label>
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								...
								<button class="btn btn-sm btn-default col-sm-3" type="button" onclick="_reset()" style="color: white;"> Cancel</button>
							</div>
						</div>
					</div>
				</div>
